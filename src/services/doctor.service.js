...
export class MeetingService {
    ...
    create(id, date,status, patientid, doctorid, consultationId) {
        ...
        return this.MeetingRepository.save(consultation)
        ...
        update(id, date,status, patientid, doctorid, consultationId) {
           return this.MeetingRepository.update(id, date,status, patientid, doctorid, consultationId);
